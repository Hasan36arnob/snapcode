...
const ChatHistoryPage = async ({ params }: { params: { id: string } }) => {
	...
	return (
		<div className='bg-[#f4f1de] h-screen flex-[3_3_0%] flex flex-col px-4 text-[#3d405b] relative overflow-hidden'>
			<div 
			...
			<div className='bg-[#3d405b]/5 backdrop-blur-sm flex-1 overflow-y-auto rounded-2xl my-4 border border-[#3d405b]/10 py-4 px-5 relative z-10 shadow-inner'>
				{/* Message container */}
